    ...
    if (CV_infreq_th1 != 0){
      if ( q == 1) {
        ...
        d <- (C_infreq - D_infreq*dc_infreq)/C_infreq^2 + #g2
          ...
          (C_infreq^3*(Q(1, x)^2*si^2 + D_infreq*2*Q(1, x)*si^2) - D_infreq*Q(1, x)^2*si^2*(3*C_infreq^2*dc_infreq) #g5
          )/C_infreq^6/s^2 - 
          (C_infreq^2*2*Q(1, x)*si - Q(1, x)^2*si*2*C_infreq*dc_infreq #g6
          )/C_infreq^4/s
      } else if (q == 2) {
        ...
        d <- (C_infreq - D_infreq*dc_infreq)/C_infreq^2 + #g2
          ...
          (C_infreq^3*Q(1, x)^2*(si^2 + D_infreq*2*si*2) - D_infreq*Q(1, x)^2*si^2*3*C_infreq^2*dc_infreq #g5
          )/C_infreq^6/s^2 - 
          (C_infreq^2*Q(1, x)^2*2 - Q(1, x)^2*si*2*C_infreq*dc_infreq #g6
          )/C_infreq^4/s
      } else if(q > k) {
        d <- 1
      } else {
        ...
        d <- (C_infreq - D_infreq*dc_infreq)/C_infreq^2 + #g2
          ...
          ( - Q(1, x)*dc_infreq)/C_infreq^2 + #g4
          (C_infreq^3*Q(1, x)^2*(si^2 + D_infreq*2*si*q*(q - 1)) - D_infreq*Q(1, x)^2*si^2*3*C_infreq^2*dc_infreq #g5
          )/C_infreq^6/s^2 - 
          (C_infreq^2*Q(1, x)^2*q*(q - 1) - Q(1, x)^2*si*2*C_infreq*dc_infreq
          )/C_infreq^4/s
      }
      return(d)
    } else {
